        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (Session["publicKey"] != null)
                {
                    ...
                    icNo = Session["icNo"].ToString();
                }

                string noteAddress = "0xDA9FF0AD12E1C775374814E973067681E41C513E";
                ...
                con.Open();
                string query1 = "SELECT status FROM Client WHERE icNo = @icNo";
                ...
                if (status == "verified")
                {
                    string query2 = "SELECT lenderID FROM Lender WHERE icNo = @icNo";
