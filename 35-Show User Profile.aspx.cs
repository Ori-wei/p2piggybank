    ...
    public partial class WebForm20 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                Debug.WriteLine("Check if borrower parse to next page: " + borrowerID);
                Debug.WriteLine("Check if lender parse to next page: " + lenderID);
        ...
        protected void BindAppDetail2(string clientID)
        {
            ...
            if (AppDetail2.Rows.Count > 0)
            {
                ...
                if (icDocButton != null)
                {
                    ...
                    string decryptedIcDoc = dataRow["icDoc"].ToString();
                    icDocButton.CommandArgument = "icDoc," + decryptedIcDoc;
                }
            }
        }
