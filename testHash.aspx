...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <script>
        ...
        function insertInvestedNote(noteAddress, amount) {
            ...
            return new Promise((resolve, reject) => {
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        resolve(response.d); // Assuming 'response.d' is where the data is. Adjust as per your response structure.
                    },
