    ...
    public partial class WebForm14 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                string status = (string)cmdCheck.ExecuteScalar();
        ...
        {
            LinkButton btnVerify = sender as LinkButton;
            string clientID = Session["clientID"].ToString();
            ...
            string query = "update Client set status = 'verified' where clientID ='" + clientID + "'";
            ...
            string client = checkClient.GetClientDetails(clientID);
            ...
            pkey1.Value = clientID;
            callScript.Value = "reviewed";
        }

        protected void Back_Click(object sender, EventArgs e)
        {
            Response.Redirect("Admin Background Verification 1.aspx");
        }
    }
}